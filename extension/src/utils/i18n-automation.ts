...
export default class I18nAutomation {
	...
	private initializeChatHistory(targetLanguage: string) {
		this.chatHistories[targetLanguage] = [{
			role: "system",
			content: `You are a professional translator for the Sieve Clipper browser extension.

About the extension:
- It's a browser extension that helps users capture web content to their knowledge base

...
def test_base_metadata_has_all_tables():
    ...
    expected = {"users", "sieves", "capsules", "leader_packs", "subscriptions", "reviews", "follows", "skills", "skill_capsules"}
...
def test_user_table_columns():
    ...
    expected = {"id", "email", "username", "password_hash", "display_name", "is_admin", "api_key", "created_at", "oauth_provider"}
